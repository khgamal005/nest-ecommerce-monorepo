// FAKE CATEGORY DATA — placeholder until the real categories endpoint is wired up.
// Three levels: category -> subcategory -> sub-subcategory (matches marketplace layout).
...
export const threeLevelCategories: CategoryNode[] = [
  {
    id: 'cat-1',
    name: 'إلكترونيات',
    slug: 'electronics',
